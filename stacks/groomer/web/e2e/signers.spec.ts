 ...
 *
 * MOUNTED ON THE GROOMER TOO, even though a groomer does not issue: `demo-up.sh` configures every
 * vet-api instance with the same contracts, and REMOVAL is the safety direction — a shop must be
 * able to see who may sign in its name and withdraw a key it no longer trusts.
 *
