...
/**
 * Local record index. The vet backend (routes.rs) exposes no "list records" endpoint —
 * records are addressed by id (share/revoke/get). The portal therefore keeps a local index
 * of records it has issued this session/device so the Records list has something to render.
 */
