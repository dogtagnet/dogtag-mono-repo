...
/**
 * Dedicated-unlock-route E2E for the VET portal, against a MOCKED backend.
 *
...
const ADMIN_TOKEN_KEY = "vet.adminToken";
...
const shot = (page: Page, name: string) =>
  page.screenshot({ path: join(SHOTS, `vet-${name}.png`), fullPage: true });
