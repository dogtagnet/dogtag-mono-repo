...
| DogTagSBTConsent (Level-B; canonical M5 target) | `0x96Cba4580D79bc9b8e51Fc1B3a044A29592AfFFc` | Deployed block 202601; write-once `profileRoot`; neutral custodian `0x637A5146…`; verified, **not live until M7** |
