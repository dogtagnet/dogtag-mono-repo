...
```
PET ONBOARDING (vet "Register pet (issue dog tag)" — device supplies its address):
  vet operator → "Register pet (issue dog tag)" wizard (enters ownerIdentity{country,identification,name} + pet fields)
