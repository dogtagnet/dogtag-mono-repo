...
> AGENTS.md "M5 as-built"). The M5 contract side has landed but is **NOT deployed and NOT wired**: this
> Level-A flow is what actually runs today, and the cutover is M7. Read the below as as-built Level-A, not
