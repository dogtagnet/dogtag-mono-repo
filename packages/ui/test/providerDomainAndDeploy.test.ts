...
describe("canCreateService is asked AS THE FACTORY, because msg.sender is one of its terms", () => {
  it("sends `account` = the configured factory on the eth_call", async () => {
    ...
    const contracts = {
      core: "0x9309aB1c2d3E4F5061728394A5B6C7D8E9F00112" as Address,
      factory: "0x1C9Ac2eB3f1A2D4B5C6d7E8f90A1B2C3D4e5F607" as Address,
      domainResolver: "0x7A9b0C1d2E3F4a5B6C7d8e9f0A1B2c3D4e5F6A7b" as Address,
      directory: "0x8b0c1D2E3f4a5B6c7D8E9F0A1B2C3d4E5f6A7b8C" as Address,
    };
